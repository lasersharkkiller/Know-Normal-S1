Import-Module -Name ".\KnowNormalModules\ParentProc.psm1"
Import-Module -Name ".\KnowNormalModules\ProcSignature.psm1"
Import-Module -Name ".\KnowNormalModules\ProcSignatureSignedVerifedCheck.psm1"
Import-Module -Name ".\KnowNormalModules\ProcSignatureCompareToEnterprise.psm1"
Import-Module -Name ".\KnowNormalModules\ProcImagePath.psm1"
Import-Module -Name ".\KnowNormalModules\NetworkPortsforAlertProc.psm1"
Import-Module -Name ".\KnowNormalModules\NetworkPortsforEnterprise.psm1"
Import-Module -Name ".\KnowNormalModules\DstIPsforAlertProc.psm1"
Import-Module -Name ".\KnowNormalModules\DstIPsforEnterprise.psm1"
Import-Module -Name ".\KnowNormalModules\DnsReqsforAlertProc.psm1"
Import-Module -Name ".\KnowNormalModules\DnsReqsforEnterprise.psm1"
Import-Module -Name ".\KnowNormalModules\IndicatorsforAlertProc.psm1"
Import-Module -Name ".\KnowNormalModules\IndicatorsforEnterprise.psm1"
Import-Module -Name ".\KnowNormalModules\IncidentQueryThreatInfo.psm1"
...
$API_TOKEN = ''
$BASE_URL = 'https://yoursite.sentinelone.net'
